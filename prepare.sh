...
wget -O plog.zip https://github.com/SergiusTheBest/plog/archive/master.zip
unzip plog.zip plog-master/include/*
mv plog-master/include/plog include/
rmdir plog-master/include && rmdir plog-master
